...
const SinglePage = () => {
  ...
  <div className="w-1/2 px-2">
    <button className="w-full bg-green-700 dark:bg-green-600 text-white py-2 px-4 rounded-full font-bold hover:bg-green-600 dark:hover:bg-green-500 transition duration-300 ease-in-out shadow-md transform hover:scale-105">
      Edit Details
    </button>
  </div>
  <div className="w-1/2 px-2">
    <button className="w-full bg-red-600 dark:bg-red-700 text-white py-2 px-4 rounded-full font-bold hover:bg-red-500 dark:hover:bg-red-600 transition duration-300 ease-in-out shadow-md transform hover:scale-105">
      Delete Product
    </button>
  </div>
</div>
